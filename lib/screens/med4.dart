...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen4(),
  ));
}

class MeditationVideoScreen4 extends StatefulWidget {
  @override
  _MeditationVideoScreen4State createState() => _MeditationVideoScreen4State();
}

class _MeditationVideoScreen4State extends State<MeditationVideoScreen4> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medmind.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
