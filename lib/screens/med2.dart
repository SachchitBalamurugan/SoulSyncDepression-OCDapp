...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen2(),
  ));
}

class MeditationVideoScreen2 extends StatefulWidget {
  @override
  _MeditationVideoScreen2State createState() => _MeditationVideoScreen2State();
}

class _MeditationVideoScreen2State extends State<MeditationVideoScreen2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/meditationVideo2.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
