...
class MeditationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Let's medida")),
      body: Container(
          ...
          children: [
              ...
              child: ClipOval(
                child: CustomPaint(
                  painter: CircleProgressPainter(
                    progress: 0.25, // Replace with your actual progress value (0 to 1)
            ...
            Container(
              ...
              child: LinearProgressIndicator(
                value: 0.5, // Replace with your actual progress value (0 to 1)
