...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen6(),
  ));
}

class MeditationVideoScreen6 extends StatefulWidget {
  @override
  _MeditationVideoScreen6State createState() => _MeditationVideoScreen6State();
}

class _MeditationVideoScreen6State extends State<MeditationVideoScreen6> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medvision.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
