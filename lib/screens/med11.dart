...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen11(),
  ));
}

class MeditationVideoScreen11 extends StatefulWidget {
  @override
  _MeditationVideoScreen11State createState() => _MeditationVideoScreen11State();
}

class _MeditationVideoScreen11State extends State<MeditationVideoScreen11> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medvaca.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
