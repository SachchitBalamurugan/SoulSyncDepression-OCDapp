...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen7(),
  ));
}

class MeditationVideoScreen7 extends StatefulWidget {
  @override
  _MeditationVideoScreen7State createState() => _MeditationVideoScreen7State();
}

class _MeditationVideoScreen7State extends State<MeditationVideoScreen7> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medworthy.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
