...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen8(),
  ));
}

class MeditationVideoScreen8 extends StatefulWidget {
  @override
  _MeditationVideoScreen8State createState() => _MeditationVideoScreen8State();
}

class _MeditationVideoScreen8State extends State<MeditationVideoScreen8> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medsleep.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
