            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Color bgColor = dayName == 'Tue' ? Color(0xff8eb1bb) : Color(0xff335660);
                  Color textColor = dayName == 'Tue' ? Color(0xff335660) : Color(0xff8eb1bb);
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(17 * fem, 23 * fem, 17 * fem, 14.5 * fem),
                    width: 110 * fem,
                    height: double.infinity,
                    decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // groupRCM (148:156)
                          margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 8.69 * fem),
                          width: 56 * fem,
                          height: 44.81 * fem,
                          child: Icon(
                            donateIcon,
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(33.58 * fem, 22.29 * fem, 29.29 * fem, 14.5 * fem),
                    width: 111 * fem,
                    height: double.infinity,
                    decoration: BoxDecoration(
                      color: Color(0xff335660),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // bxpartyLCq (148:165)
                          margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 6.08 * fem),
                          width: 48.13 * fem,
                          height: 48.13 * fem,
                          child: Icon(
                            partyHatIcon,
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(20.5 * fem, 23.25 * fem, 20.5 * fem, 14.5 * fem),
                    width: 110 * fem,
                    height: double.infinity,
                    decoration: BoxDecoration(
                      color: Color(0xff335660),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 7.75 * fem),
                          width: 48.75 * fem,
                          height: 45.5 * fem,
                          child: Icon(
                            groupIcon,
