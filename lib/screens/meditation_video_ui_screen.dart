...
class _MeditationVideoScreenState extends State<MeditationVideoScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            const Text("Let's Meditate", style: TextStyle(fontSize: 20, color: Colors.white),),
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  icon: Icon(_isPlaying ? Icons.pause : Icons.play_arrow, size: 80, color: Colors.white),
                ),
                SizedBox(width: 16),
                IconButton(
