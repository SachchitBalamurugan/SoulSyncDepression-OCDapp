...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen10(),
  ));
}

class MeditationVideoScreen10 extends StatefulWidget {
  @override
  _MeditationVideoScreen10State createState() => _MeditationVideoScreen10State();
}

class _MeditationVideoScreen10State extends State<MeditationVideoScreen10> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medletgo.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
