...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen3(),
  ));
}

class MeditationVideoScreen3 extends StatefulWidget {
  @override
  _MeditationVideoScreen3State createState() => _MeditationVideoScreen3State();
}

class _MeditationVideoScreen3State extends State<MeditationVideoScreen3> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medrelax.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
