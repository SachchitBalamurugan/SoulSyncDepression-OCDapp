...
void main() {
  runApp(MaterialApp(
    home: MeditationVideoScreen9(),
  ));
}

class MeditationVideoScreen9 extends StatefulWidget {
  @override
  _MeditationVideoScreen9State createState() => _MeditationVideoScreen9State();
}

class _MeditationVideoScreen9State extends State<MeditationVideoScreen9> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.asset('videos/medchakra.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
